...
describe('The Object type', function () {
    ...
    describe('When we validate an object', function () {
        ...
        it('Should allow us to pass in a key to validate only that item', function () {
            var field = new ObjectType({
    ...
    it('Should throw an error if we get a key that does not exist', function () {
        var field = new ObjectType({});
    ...
    it('Should not apply data that does have a field', function () {
        var field = new ObjectType({});
    ...
    it('Should trigger a change event when we apply to the object', function (done) {
        var field = new ObjectType({
            name: BaseType
        });
    ...
    it('Should have a getFields() method', function () {
        var field = new ObjectType({
            name: BaseType
        });
